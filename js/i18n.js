...
export const TRANSLATIONS = {
  es: {
    ...
    "ui.aboutText": "Regata del Viento es una carrera móvil de barcos en 8 bits. Mantén pulsado el timón, gira con el dedo y compite en río, mar, slalom y mapas especiales.",
    "mode.time": "Mejor tiempo",
    "mode.race": "Contra IA",
    "course.river": "Río",
    "course.sea": "Mar",
    "course.slalom": "Slalom",
    "course.mangrove": "Manglar",
    "course.canyon": "Cañón",
    "course.storm": "Tormenta",
  ...
  en: {
    ...
    "ui.close": "Close",
    "ui.aboutTitle": "About",
    "ui.aboutText": "Wind Regatta is a mobile 8-bit boat racer. Hold the wheel, steer with your finger and race river, sea, slalom and special maps.",
    "mode.time": "Best time",
    "mode.race": "Versus AI",
    "course.river": "River",
    "course.sea": "Sea",
    "course.slalom": "Slalom",
    "course.mangrove": "Mangrove",
    "course.canyon": "Canyon",
    "course.storm": "Storm",
